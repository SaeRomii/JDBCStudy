...
-- 직원 정보 입력 데이터의 형태
INSERT INTO TBL_EMP(EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG)
VALUES (EMPSEQ.NEXTVAL, '선혜연', '951102-2234567', TO_DATE('2020-02-12', 'YYYY-MM-DD')
      , (SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC='경기')
      , '010-1111-1111'
      , (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME='개발부')
      , (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME='사원')
      , 850000
      , 2000000 );
--> 한 줄 구성
INSERT INTO TBL_EMP(EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES (EMPSEQ.NEXTVAL, '선혜연', '951102-2234567', TO_DATE('2020-02-12', 'YYYY-MM-DD'), (SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC='경기'), '010-1111-1111', (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME='개발부'), (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME='사원'), 850000, 2000000 )
;
--==>> 1 행 이(가) 삽입되었습니다.
...
SELECT EMP_ID, NAME, SSN, TO_CHAR(IBSADATE, 'YYYY-MM-DD'), AS IBSADATE, CITY_ID, CITY
     , TEL, BUSEO_ID, BUSEO, JIKWI_ID, JIKWI, BASICPAY, SUDANG, PAY
FROM EMPVIEW
WHERE EMP_ID = 1001
ORDER BY EMP_ID;
...
--WHERE JIKWI_NAME='대리';
--이런식으로 조건 걸어서 해야하는데 BUSEO_NAME이랑 JIKWI_NAME이 없어서 VIEW 활용
...
--8. 직원 데이터 전체 조회 쿼리문(사번/이름/부서/직위/급여내림차순 정렬)
...
--9. 검색 직원 리스트 출력 쿼리문 (사번/이름/부서/직위)
SELECT EMP_ID, EMP_NAME, SSN, TO_CHAR(IBSADATE, 'YYYY-MM-DD') AS IBSADATE
     , CITY_LOC, TEL, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY
FROM EMPVIEW
WHERE EMP_ID=1001;
...
--10. 수정 쿼리
UPDATE TBL_EMP
SET EMP_NAME = '한석봉', SSN = '811112-1566789', IBSADATE = TO_DATE('2004-08-13', 'YYYY-MM-DD')
  , CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC='서울')
  , TEL = '018-5211-3542'
  , BUSEO_ID = (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '총무부')
  , JIKWI_ID = (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사원')
  , BASICPAY = 1420000
  , SUDANG = 160000
WHERE EMP_ID = 1005;
--> 한 줄 구성
UPDATE TBL_EMP SET EMP_NAME = '한석봉', SSN = '811112-1566789', IBSADATE = TO_DATE('2004-08-13', 'YYYY-MM-DD'), CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC='서울'), TEL = '018-5211-3542', BUSEO_ID = (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '총무부'), JIKWI_ID = (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사원'), BASICPAY = 1420000, SUDANG = 160000 WHERE EMP_ID = 1005
;
